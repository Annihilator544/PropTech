  ...
  return (
    <footer className="py-32">
      <div className="grid grid-cols-[60%,40%]">
        <div>
            <p className="text-[42px] lora">Start your property </p>
            <p className="text-[42px] lora">journey now!</p>
      ...
      <div className=' flex justify-between border-b-[1px] border-t-[1px] py-8 my-14'>
        <div>
